...
// Load base env first, then let the environment-specific file override it.
...
const allowedOrigins = new Set(
  [...configuredOrigins, ...defaultAllowedOrigins]
    .filter(Boolean)
...
const isAllowedOrigin = (origin) => {
  ...
  return (
    allowedOrigins.has(normalizedOrigin) || isRenderOrigin(normalizedOrigin)
  );
};
